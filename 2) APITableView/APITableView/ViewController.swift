...
//  APITableView
//
//  Created by César Manuel on 09/01/23.
//
                ...
                if let urlContent = data{
                    do{
                        ...
                        for i in 0...nations.count - 1 {
                            ...
                            let mycountry = Nation(country: (dictionary["name"] ?? "No country available") as! String, flag: (dictionary["image"] ?? "No flag available") as! String, code: (dictionary["code"] ?? "No code available") as! String)
